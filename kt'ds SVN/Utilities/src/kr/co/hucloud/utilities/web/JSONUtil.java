...
import kr.co.hucloud.utilities.web.jsontest.VO;
...
//			Field[] fields = returnObject.getClass().getDeclaredFields();
	...
	public static void main(String[] args) {
		String str = "{ \"name\" : \"aaa\", \"tempList\":[{\"tempString\" : \"temp1\", \"tempName\" : \"tempName1\"},{\"tempString\" : \"temp2\", \"tempName\" : \"tempName2\"}], \"paging\": {\"totalArticleCount\": 10, \"startArticleNumber\" : 1, \"endArticleNumber\" : 10}}";
		VO vo = new VO();
		vo = JSONUtil.toInstance(str, vo);
		System.out.println(vo.getName());
		System.out.println(vo.getTempList().get(0).getTempName());
	}
