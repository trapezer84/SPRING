	...
	<table style="border: 1px solid black; margin: 15px;">
		...
		<tr style="text-align: center;">
			...
			method="post" action="/board/doEdit">
				...
				<input type="hidden" id="articleID" value="${ article.articleID }" name="articleID"/>${ article.articleID }</td>
				...
				<input type="hidden" id="writer" value="${ article.writer }" name="writer"/>${ article.writer }</td>
				...
				<input type="hidden" id="createdDate" value="${ article.createdDate }" name="createdDate"/>
				
				<td style="background-color: lightgray;">${ article.modifiedDate }</td>
				<input type="hidden" id="modifiedDate" value="${ article.modifiedDate }" name="modifiedDate"/>
